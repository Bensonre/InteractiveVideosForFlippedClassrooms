<?php
    ...
    if ($controller->create($title, $ivcInstructorId, $videoId)) {
        $databaseEntryCreated = true;
    }

    $response = array("success" => 0, "message" => "The package was not successfully created.");

    if($databaseEntryCreated == true) {
        $response['success'] = 1;
        $response['message'] = "The package was successfully created.";
    }
